        ...
        <div class="food-container container">
            <div class="food-type">
                <div class="img-container">
                    <img src="Images/Bevereges.jpg" alt="Bevereges" />
				 ...
				 %>
					<%if(food.getFoodName().equalsIgnoreCase("Chicago  style pizza")){%>
						<tr  class="table-row">
							...
							<td class="food-img"><img src='image/Chicagopizza.jpg' style="border-radius:50%;" width="80px" height="60px" alt="indigo"/></td>
						
							<td class="food-description"><%=food.getFoodName() %></td> 
						   
							<td class="food-price">Price: <%=food.getPrice() %></td>	
							<td><%=food.getAbout() %></td>	
							<td><%=food.getOffer() %></td>	
