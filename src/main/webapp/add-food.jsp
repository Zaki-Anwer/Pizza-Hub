      ...
      <div class="add_section">
        <form action="food" method="post">
          ...
          <div>
            ...
            <input type="text" name="pizza_name" placeholder="Pizza Name">
            <input type="text" name="Pizza_desc" placeholder="desc">
          </div>
          <div>
            ...
            <input type="text" name="pizza_price" placeholder="Price">
          </div>
          <div>

            <input type="text" name="pizza_offer" placeholder="offer">
          </div>
