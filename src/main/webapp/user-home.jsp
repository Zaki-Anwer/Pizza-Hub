<%@page import="com.opkey.pizza_hut.Dto.UserRegistration"%>
<%@page import="com.opkey.pizza_hut.Service.UserRegistrationService"%>
<html lang="en">
...
<body>
              ...
              <%
                        ...
                        UserRegistration user = service.getByEmail(email);
              %>
            ...
            <div class="menu-bar">
                <ul>
                    <li >
                        ...
                        <a href="#">
                       <div>
                      <input type="text" value="<%= user.getName() %>" class="ab">
                   </div>
                    </div>
                </div>
    ...
    <section id="food-menu">
        ...
        <div class="food-menu-container container">
            ...
            <div class="food-menu-item">
                <div class="food-img">
                    <img src="Images/Italianpizza.jpg" alt="error" />
                </div>
                <div class="food-description">
